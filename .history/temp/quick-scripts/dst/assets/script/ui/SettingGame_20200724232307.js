(function () {
	...
	function __define(exports, require, module) {
		if (!nodeEnv) {
			__quick_compile_project__.registerModule(__filename, module);
		}
		('use strict');
		...
		let SettingGame = /** @class */ (() => {
			...
			__decorate([property(cc.Node), __metadata('design:type', typeof (_a = typeof cc !== 'undefined' && cc.Node) === 'function' ? _a : Object)], SettingGame.prototype, 'settingButton', void 0);
			SettingGame = __decorate([ccclass], SettingGame);
			return SettingGame;
		})();
